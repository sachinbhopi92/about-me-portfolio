                ...
                <ul className="space-y-3 text-slate-600 dark:text-slate-300">
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <span>
                      ...
                      integration for advanced WYSIWYG content editing with rich
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <span>
                      ...
                      workflows using Cursor AI and GitHub Copilot, dramatically
                      accelerating delivery and achieving superior test coverage
                    </span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <svg
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <span>
                      ...
                      active participation in sprint planning, pre-grooming, and
                      precise story estimation
                    </span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <svg
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <span>
                      ...
                      Registry, npm, and yarn ecosystems, demonstrating advanced
            ...
            <ul className="space-y-2 text-slate-600 dark:text-slate-300">
              <li className="flex items-start space-x-3">
                ...
                <span>
                  ...
                  Fotech division, focusing on HTML, CSS, JavaScript, Bootstrap,
                  and AngularJS implementation for client-facing applications
                </span>
              </li>
              <li className="flex items-start space-x-3">
                <svg
            ...
            <div className="space-y-6">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-green-100 to-blue-100 dark:from-green-900/30 dark:to-blue-900/30 rounded-lg border-l-4 border-green-500">
                ...
                <p className="text-center text-slate-700 dark:text-slate-300 mt-4 font-medium">
                  <strong>
                    "Hard work, dedication, and technical excellence recognized
                    through consistent career advancement"
                  </strong>
                </p>
              </div>
            </div>
